...
import it.hurts.sskirillss.rbocompat.client.renderer.entities.BaseBabylonianWeaponRender;
...
import vazkii.botania.client.render.entity.BabylonWeaponRenderer;
...
public class RemoteRegistry {
    ...
    public static void entityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityRegistry.BABYLON_WEAPON.get(), BaseBabylonianWeaponRender::new);
